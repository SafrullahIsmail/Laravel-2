                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="normal-input" name="thumbnail" type="file" class="form-control" placeholder="Post title">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Product description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
